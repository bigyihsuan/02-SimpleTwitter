...
import com.codepath.apps.simpletwitter.models.TweetDao;
import com.codepath.apps.simpletwitter.models.TweetWithUser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                Log.i(TAG, "onRefresh: " + "Fetching data...");
        ...
        // init the tweet lists and adapter
    ...
    private void loadMoreData() {
        ...
        client.getNextPageOfTweets(new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Headers headers, JSON json) {
                Log.i(TAG, "onSuccess getNextPageOfTweets: " + json.toString());
        ...
        Log.i(TAG, "loadMoreData: " + tweets.get(tweets.size() - 1).id);
    }
            ...
            public void onSuccess(int statusCode, Headers headers, JSON json) {
                ...
                try {
                    ...
                    AsyncTask.execute(new Runnable() {
                        @Override
                        public void run() {
                            Log.i(TAG, "run: saving data to database");
